...
export const metadata: Metadata = {
  title: "Services",
  description:
    "Strength & conditioning, speed & agility training, sport-specific coaching, youth athletic development, injury prevention, nutrition & recovery coaching and team training camps in Austin, TX.",
};
      ...
      <section className="px-4 pb-8 pt-36 sm:pt-40">
        <div className="mx-auto max-w-6xl">
          <SectionHeading
            ...
            title="Seven programs, built around your sport"
            subtitle="Every athlete gets an assessment, a data-driven plan and a coach who knows your sport. Here is what we do."
          />
        </div>
      </section>
      ...
      <section className="px-4 py-10 sm:py-14">
        <div className="mx-auto max-w-6xl">
              ...
              <StaggerItem key={s.slug} className="h-full">
                ...
                >
                  <div className="relative h-44 overflow-hidden">
                    <Image
                      src={s.image}
                      alt={`${s.name} at PeakEdge Sports Performance`}
                      fill
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    <div className="flex items-center gap-3">
                      ...
                      <h2 className="font-display text-lg font-bold uppercase text-foreground">{s.name}</h2>
                    </div>
                    <p className="mt-3 flex-1 text-sm leading-relaxed text-muted-foreground">
                      {s.description}
                    </p>
                    <span className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-accent">
                      Program details <ArrowRight className="size-4 transition-transform group-hover:translate-x-1" />
                    </span>
                  </div>
                </Link>
              </StaggerItem>
          ...
          <Reveal className="mt-14 text-center">
            <p className="text-muted-foreground">Not sure which program fits?</p>
            <Link
              href="/contact"
