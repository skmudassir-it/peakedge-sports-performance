...
export function CtaBand({
  title = "Ready to perform at your peak?",
  subtitle = "Book your free assessment today. Our coaches respond within one business day — and usually much faster.",
      ...
      <Reveal className="mx-auto max-w-6xl">
        <div className="glass-card relative overflow-hidden rounded-3xl">
          <div className="absolute inset-0 -z-10">
            <Image
              src={image}
              alt="Athlete training hard at PeakEdge Sports Performance"
              fill
              sizes="100vw"
